...
%И побежали.
% Мы бежали из плена.
% Мы было бы невозможно для нас,если бы  не сильные дожди ,наводнения и темнота,которая была в городе.
%"Нам Бог помог.."
...
%Будто бы мы много лет между нами была близкость.
%Имя не знает.
...
— Отныне ты являешься андартес,— оценивающе оглядывая меня, сказал капитан.— Береги честь этого звания.
